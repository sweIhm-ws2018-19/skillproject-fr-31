...
public class BackToStartIntentHandlerTest {
    ...
    public void test_Ctor() {
        assertEquals(handler.getClass(), BackToStartIntentHandler.class);
    }
    ...
    public void handleTest() {
        ...
        sessionAttributes.put(GuideStates.STATE.getKey(), "test");
        ...
        assertTrue(response.getOutputSpeech().toString().contains("Du kannst nun wieder die Hilfefunktion aufrufen oder eine Route erfragen"));
    }
}
