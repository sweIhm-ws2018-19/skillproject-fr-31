...
public class ConfirmationHandler implements RequestHandler {
    ...
    private ArrayList<GuideStates> confirmationStates=new ArrayList<>(Arrays.asList(GuideStates.SAY_DEST_ADDR_AGAIN,GuideStates.Q_NEXT_ADDR, GuideStates.CONFIG, GuideStates.NEW_CONFIG));
